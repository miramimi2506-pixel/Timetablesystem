...
def check_and_fix_database_schema():
    try:
        ...
        if 'semester' not in column_names:
            ...
            cur.execute("ALTER TABLE timetable ADD COLUMN semester ENUM('ODD','EVEN') NOT NULL DEFAULT 'ODD'")
            print("✓ Added semester column")
        
        # Add updated_at column if missing
        if 'updated_at' not in column_names:
            print("Adding updated_at column to timetable table...")
            cur.execute("ALTER TABLE timetable ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")
        ...
        if 'semester' not in column_names:
            ...
            cur.execute("ALTER TABLE subjects ADD COLUMN semester ENUM('ODD','EVEN') NOT NULL DEFAULT 'ODD'")
